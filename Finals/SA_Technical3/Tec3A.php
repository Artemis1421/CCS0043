<?php
	if(isset($_POST['submitButton'])){
		...
		if(@$pass == @$confirmPass and @$pass != ""){
			$fullname = "<p style=\"font-size:20px; padding-left: 100px\"><b>Full Name</b>: ".@$fname." ".@$mname." ".@$lname."</p>";
			$uname = "<p style=\"font-size:20px; padding-left: 100px\"><b>Username</b>: ".@$uname."</p>";
			$pass = "<p style=\"font-size:20px; padding-left: 100px\"><b>Password</b>: ".@$pass."</p>";
			$birthday = "<p style=\"font-size:20px; padding-left: 100px\"><b>Birthday</b>: ".@$birthday."</p>";
			$email = "<p style=\"font-size:20px; padding-left: 100px\"><b>Email</b>: ".@$email."</p>";
			$contact = "<p style=\"font-size:20px; padding-left: 100px\"><b>Contact Number</b>: ".@$contact."</p>";
		}
		else {
			$msg = "<p style=\"font-size:20px; padding-left: 100px; color:red\">Password and Confirm password are not the same. Please try again.</p>";
			$fullname = "";
			$uname = "";
			$pass = "";
			$birthday = "";
...
<head>
	...
	<title>Laboratory Problem #1A</title>
</head>
